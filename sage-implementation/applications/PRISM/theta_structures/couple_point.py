...
class CouplePoint:
    ...
    # for list destructuration
    # using only __getitem__ the destructuration tries to get the item value 2 which does not exist
    def __iter__(self):
    ...
    def weil_pairing(self, other, n):
        ...
        ePQ1 = weil_pairing_default(P1, Q1, n)
        ePQ2 = weil_pairing_default(P2, Q2, n)
