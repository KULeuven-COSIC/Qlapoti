...
from utilities.pairing import tate_pairing_default
...
def compress_two_torsion_basis(
    ...
    ePQ = tate_pairing_default(P, Q, D, exp=e)
...
def recover_lost_scalar(R, S, P, Q, b, deg_phi, aR, bR, xS, window):
    ...
    ePQ = tate_pairing_default(P, Q, D, exp=exp)
    eRS = tate_pairing_default(R, S, D, exp=exp)
